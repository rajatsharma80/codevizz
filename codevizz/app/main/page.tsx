...
export default function Home() {
  ...
  // const [paypalLoaded, setPaypalLoaded] = useState(false); // PAYMENT DISABLED — uncomment to restore PayPal
  ...
  /* PAYMENT DISABLED — uncomment to restore PayPal donation buttons
  ...
  const handleGenerate = async () => {
    ...
    if (response.ok) {
      ...
      if (type === 'Sequence Diagram') {
        // Strip activate/deactivate lines to prevent Mermaid mismatched activation errors
        diagramOutput = diagramOutput
          .split('\n')
          .filter((line: string) => !/^\s*(activate|deactivate)\s+\S+/.test(line))
          .join('\n');
      }
...
${output}`;
  ...
  /* SAVE DISABLED — uncomment to restore save functionality
  ...
  return (
    <>
      ...
      ${
        ...
        {/* SAVE DISABLED — uncomment to restore Save button
        ...
        */}
        ...
        {/* PAYMENT DISABLED — uncomment to restore donation section
